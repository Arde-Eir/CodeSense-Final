...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c155 = "return",
      peg$c156 = peg$literalExpectation("return", false),
      peg$c157 = function(value) { return { type: 'ReturnStatement', value, ...loc() }; },
      peg$c158 = function() { return { type: 'ReturnStatement', value: null, ...loc() }; },
      peg$c159 = "if",
      peg$c160 = peg$literalExpectation("if", false),
      peg$c161 = "else",
      peg$c162 = peg$literalExpectation("else", false),
      peg$c163 = function(condition, thenBranch, elseBranch) {
            return {
              type: 'IfStatement',
              condition,
      ...
      peg$c164 = function(condition, body) {
            return {
              type: 'WhileLoop',
              condition,
              body: body.type === 'Block' ? body.statements : [body],
      ...
      peg$c167 = function(type, name, range, body) {
            return {
              type: 'RangeBasedFor',
              varType: type,
              name,
      ...
      peg$c168 = function(expr) { return { type: 'ExpressionStatement', expression: expr, ...loc() }; },
      peg$c169 = function() { return null; },
      peg$c170 = function(init, condition, update, body) {
            return {
              type: 'ForLoop',
              init: init || null,
      ...
      peg$c230 = function(type, operand) { return { type: 'CastExpression', targetType: type, operand, ...loc() }; },
      peg$c231 = "sizeof",
      peg$c232 = peg$literalExpectation("sizeof", false),
      peg$c233 = function(expr) { return { type: 'SizeofExpression', value: expr, ...loc() }; },
      peg$c234 = function(operand) { return { type: 'UnaryOp', operator: '-',  operand, ...loc() }; },
      peg$c235 = "!",
      peg$c236 = peg$literalExpectation("!", false),
      peg$c237 = function(operand) { return { type: 'UnaryOp', operator: '!',  operand, ...loc() }; },
      peg$c238 = "~",
      peg$c239 = peg$literalExpectation("~", false),
      peg$c240 = function(operand) { return { type: 'UnaryOp', operator: '~',  operand, ...loc() }; },
      peg$c241 = function(operand) { return { type: 'Dereference',  operand, ...loc() }; },
      peg$c242 = function(operand) { return { type: 'AddressOf',    operand, ...loc() }; },
      peg$c243 = "++",
      peg$c244 = peg$literalExpectation("++", false),
      peg$c245 = function(name) { return { type: 'PreIncrement',  operand: name, ...loc() }; },
      peg$c246 = "--",
      peg$c247 = peg$literalExpectation("--", false),
      peg$c248 = function(name) { return { type: 'PreDecrement',  operand: name, ...loc() }; },
      peg$c249 = function(name) { return { type: 'PostIncrement', operand: name, ...loc() }; },
      peg$c250 = function(name) { return { type: 'PostDecrement', operand: name, ...loc() }; },
      peg$c251 = "nullptr",
      peg$c252 = peg$literalExpectation("nullptr", false),
      peg$c253 = function() { return { type: 'Identifier', name: 'nullptr', ...loc() }; },
      peg$c254 = function(name) { return { type: 'Identifier', name: "std::" + name, ...loc() }; },
      peg$c255 = /^[a-zA-Z_]/,
      ...
      peg$c262 = function(baseType, size) {
            return { type: 'NewExpression', baseType, size: size ? size[2] : null, ...loc() };
          },
      peg$c263 = function(capture, params, body) {
            return {
      ...
      peg$c266 = function(captureList) { return captureList; },
      peg$c267 = function(first, rest) {
            return { type: 'InitializerList', values: [first, ...rest.map(r => r[3])], ...loc() };
          },
      peg$c268 = "true",
      peg$c269 = peg$literalExpectation("true", false),
      peg$c270 = "false",
      ...
      peg$c273 = "0x",
      peg$c274 = peg$literalExpectation("0x", false),
      peg$c275 = /^[0-9a-fA-F]/,
      peg$c276 = peg$classExpectation([["0", "9"], ["a", "f"], ["A", "F"]], false, false),
      peg$c277 = /^[uUlL]/,
      peg$c278 = peg$classExpectation(["u", "U", "l", "L"], false, false),
      peg$c279 = function(hex, suffix) {
            return { type: 'Integer', value: parseInt(hex, 16), ...loc() };
          },
      peg$c280 = "0b",
      peg$c281 = peg$literalExpectation("0b", false),
      peg$c282 = /^[01]/,
      peg$c283 = peg$classExpectation(["0", "1"], false, false),
      peg$c284 = function(bin, suffix) {
      ...
      peg$c294 = function(value, suffix) {
            return { type: 'Integer', value: parseInt(value, 10), ...loc() };
          },
      peg$c295 = /^[fFlL]/,
      peg$c296 = peg$classExpectation(["f", "F", "l", "L"], false, false),
      peg$c297 = function(value, suffix) {
      ...
      peg$c305 = function(ch) {
            const raw = Array.isArray(ch) ? ch[0] + ch[1] : ch;
            return { type: 'Char', value: raw, ...loc() };
          },
      peg$c306 = "u8",
      peg$c307 = peg$literalExpectation("u8", false),
      peg$c308 = "u",
      peg$c309 = peg$literalExpectation("u", false),
      peg$c310 = "U",
      peg$c311 = peg$literalExpectation("U", false),
      peg$c312 = "L",
      peg$c313 = peg$literalExpectation("L", false),
      peg$c314 = /^[^"\\]/,
      peg$c315 = peg$classExpectation(["\"", "\\"], true, false),
      peg$c316 = function(prefix, chars) {
            return { type: 'String', value: chars, ...loc() };
          },
      peg$c317 = function(mods, base, ptr) {
            const modStr  = mods.length ? mods.join(' ') + ' ' : '';
            const ptrStr  = ptr.map(m => m[1]).join('');
            return modStr + base + ptrStr;
          },
      peg$c318 = "long",
      peg$c319 = peg$literalExpectation("long", false),
      peg$c320 = function() { return "long long"; },
      peg$c321 = "double",
      peg$c322 = peg$literalExpectation("double", false),
      peg$c323 = function() { return "long double"; },
      peg$c324 = "unsigned",
      peg$c325 = peg$literalExpectation("unsigned", false),
      peg$c326 = "int",
      peg$c327 = peg$literalExpectation("int", false),
      peg$c328 = function() { return "unsigned int"; },
      peg$c329 = function() { return "unsigned long long"; },
      peg$c330 = "float",
      peg$c331 = peg$literalExpectation("float", false),
      peg$c332 = "char",
      peg$c333 = peg$literalExpectation("char", false),
      peg$c334 = "bool",
      peg$c335 = peg$literalExpectation("bool", false),
      peg$c336 = "void",
      peg$c337 = peg$literalExpectation("void", false),
      peg$c338 = "string",
      peg$c339 = peg$literalExpectation("string", false),
      peg$c340 = "auto",
      peg$c341 = peg$literalExpectation("auto", false),
      peg$c342 = "typename",
      peg$c343 = peg$literalExpectation("typename", false),
      peg$c344 = "class",
      peg$c345 = peg$literalExpectation("class", false),
      peg$c346 = "struct",
      peg$c347 = peg$literalExpectation("struct", false),
      peg$c348 = "enum",
      peg$c349 = peg$literalExpectation("enum", false),
      peg$c350 = "size_t",
      peg$c351 = peg$literalExpectation("size_t", false),
      peg$c352 = "const",
      peg$c353 = peg$literalExpectation("const", false),
      peg$c354 = "static",
      peg$c355 = peg$literalExpectation("static", false),
      peg$c356 = "extern",
      peg$c357 = peg$literalExpectation("extern", false),
      peg$c358 = "volatile",
      peg$c359 = peg$literalExpectation("volatile", false),
      peg$c360 = "signed",
      peg$c361 = peg$literalExpectation("signed", false),
      peg$c362 = "inline",
      peg$c363 = peg$literalExpectation("inline", false),
      peg$c364 = "virtual",
      peg$c365 = peg$literalExpectation("virtual", false),
      peg$c366 = "public",
      peg$c367 = peg$literalExpectation("public", false),
      peg$c368 = "private",
      peg$c369 = peg$literalExpectation("private", false),
      peg$c370 = "protected",
      peg$c371 = peg$literalExpectation("protected", false),
      peg$c372 = "override",
      peg$c373 = peg$literalExpectation("override", false),
      peg$c374 = "final",
      peg$c375 = peg$literalExpectation("final", false),
      peg$c376 = "mutable",
      peg$c377 = peg$literalExpectation("mutable", false),
      peg$c378 = "explicit",
      peg$c379 = peg$literalExpectation("explicit", false),
      peg$c380 = "friend",
      peg$c381 = peg$literalExpectation("friend", false),
      peg$c382 = "goto",
      peg$c383 = peg$literalExpectation("goto", false),
      peg$c384 = "operator",
      peg$c385 = peg$literalExpectation("operator", false),
      peg$c386 = "register",
      peg$c387 = peg$literalExpectation("register", false),
      peg$c388 = "short",
      peg$c389 = peg$literalExpectation("short", false),
      peg$c390 = "template",
      peg$c391 = peg$literalExpectation("template", false),
      peg$c392 = "this",
      peg$c393 = peg$literalExpectation("this", false),
      peg$c394 = "typedef",
      peg$c395 = peg$literalExpectation("typedef", false),
      peg$c396 = "union",
      peg$c397 = peg$literalExpectation("union", false),
      peg$c398 = /^[ \t\r\n]/,
